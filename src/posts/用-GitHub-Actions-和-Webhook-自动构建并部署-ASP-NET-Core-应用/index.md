...
permalink: /2022/03/19/用-GitHub-Actions-和-Webhook-自动构建并部署-ASP-NET-Core-应用/
createTime: '2022-03-19 23:46:35'
lang: zh-CN
tags:
  - GitHub
  - Webhook
...
- [用-GitHub-Actions-和-SSH-部署静态网站](/2021/06/20/用-GitHub-Actions-和-SSH-部署静态网站/)
...
### 权限不足无法应用新版本
我一开始想按照之前写的[《用 GitHub Actions 和 SSH 部署静态网站》](/2021/06/20/用-GitHub-Actions-和-SSH-部署静态网站/)中的方式，用 GitHub Actions 构建并推送到另一分支，然后用 Actions SSH 连上服务器，拉取分支。这里和之前不同的地方在于，静态网站拉取分支后可以立刻生效，而动态应用更新还需要重启服务，才能生效。
