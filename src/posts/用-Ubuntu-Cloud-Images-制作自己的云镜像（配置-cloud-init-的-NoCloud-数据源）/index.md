...
permalink: /2022/03/14/用-Ubuntu-Cloud-Images-制作自己的云镜像（配置-cloud-init-的-NoCloud-数据源）/
createTime: '2022-03-14 12:32:46'
lang: zh-CN
tags:
  - Ubuntu
  - 腾讯云
...
还是之前写过的，云厂商提供的系统镜像不好使的问题。之前写过[《使用 iPXE 和 netboot.xyz 重装 VPS 系统》](/2021/09/24/使用iPXE和netboot-xyz重装VPS系统/)，但是，由于各种原因（如系统内存不足、国内网络不稳定等），其适用性受到了限制。这次改用了 Ubuntu Cloud Images，可以直接用 dd 命令覆盖系统盘，然后重装系统。
